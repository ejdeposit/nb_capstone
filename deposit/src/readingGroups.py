...
def input_sched_Times(numberOfDays):
    #set set weeks eTimes
    str1 ='For each day, enter a start time, followed by a stop time for to indicate when the morning and afternoon sessions'
    str2= 'or the reading time should begin and end. If there is no afternoon start and end time, press enter.'
    print(str1 + '\n' + str2)
